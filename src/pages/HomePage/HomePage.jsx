          ...
          <div className="bg-[var(--bg-card)] border-2 border-[var(--border-btn-header)] rounded-[20px] p-10 px-7 shadow-[0_0_25px_rgba(0,255,255,0.08)] md:px-14 md:py-10 ">
            ...
            <Motion delay={0.6}>
              <div className="flex justify-center">
                <a
                  href="https://drive.google.com/file/d/13cRCMXTJSa_PF51V-uzD-jSTHPeqK2j1/view?usp=drive_link"
                  target="_blank"
                  rel="noreferrer"
                  className="btn px-[25px] py-[10px] md:text-base lg:text-lg animate-[glowPulse_2s_ease-in-out_infinite]"
                >
                  {t("viewResume")}
                </a>
              </div>
